import { Title, Text, Anchor, Box, Container, ThemeIcon, Flex, TextInput, Button, Group, Burger } from '@mantine/core';
import classes from './Header.module.css';
import { IconBrandYoutubeFilled, IconCheck, IconHome2 } from '@tabler/icons-react';
