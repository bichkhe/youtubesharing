          ...
          <Card h="280px" shadow="md" className={classes.videoInfoCard}>
            <Group justify="space-between" className={classes.titleWrapper}>
              ...
              >
                ...
                {video_.voted && video_.voted == "DOWN" && (
                  <ActionIcon p="xs" size="xl" ml="2px">
                    <IconThumbDown />
                  </ActionIcon>
                )}
              </div>
            ...
            <Group justify="space-between" mt="sm">
              <Text fw={500} fz="0.8rem">
                Shared by: {video_.email}
              </Text>
            </Group>
