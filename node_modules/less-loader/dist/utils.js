...
const IS_SPECIAL_MODULE_IMPORT = /^~[^/]+$/; // `[drive_letter]:\` + `\\[server]\[share_name]\`
...
function getLessImplementation(loaderContext, implementation) {
  ...
  if (!implementation || typeof implementation === "string") {
    const lessImplPkg = implementation || "less"; // eslint-disable-next-line import/no-dynamic-require, global-require
