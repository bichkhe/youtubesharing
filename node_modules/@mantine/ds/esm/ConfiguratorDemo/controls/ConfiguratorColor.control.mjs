...
import { getControlLabel } from './get-control-label.mjs';
import { ColorWheelIcon } from './ColorWheelIcon.mjs';
import classes from './ConfiguratorColor.control.module.mjs';
...
function ConfiguratorColorControl(_a) {
  ...
  return /* @__PURE__ */ React.createElement(Input.Wrapper, __spreadValues({ labelElement: "div", label: getControlLabel(prop) }, others), /* @__PURE__ */ React.createElement(Group, { gap: 2, mt: 2, wrap: "wrap" }, colors, /* @__PURE__ */ React.createElement(Popover, { radius: "md", position: "bottom-end", shadow: "md" }, /* @__PURE__ */ React.createElement(Popover.Target, null, /* @__PURE__ */ React.createElement(UnstyledButton, { className: classes.colorControl, "aria-label": "Pick color" }, /* @__PURE__ */ React.createElement(ColorWheelIcon, null))), /* @__PURE__ */ React.createElement(Popover.Dropdown, { p: 8 }, /* @__PURE__ */ React.createElement(
    ColorPicker,
    {
...
//# sourceMappingURL=ConfiguratorColor.control.mjs.map
