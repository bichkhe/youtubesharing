...
import { useMantineLogoColors } from './use-mantine-logo-colors.mjs';
import classes from './MantineLogo.module.mjs';
...
function MantineLogoText(_a) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    __spreadProps(__spreadValues({}, others), {
      ...
      viewBox: "0 0 623 163",
      style: __spreadValues({ height: rem(size) }, style),
      className: cx(
        classes.logo,
...
export { MantineLogoText };
//# sourceMappingURL=MantineLogoText.mjs.map
